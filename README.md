...
게임 내에서 로비 화면전환 연출 위한 카메라 컴포넌트, 게임 내 장애물 설계를 비롯해 <br>
방목록UI와 게임 진행도UI 등 UI들을 맡아서 구현했습니다.
...
| **장르** | 수직 플랫포머 게임 |
| **플랫폼** | PC (Steam 연동) |
| **게임 컨셉** | 두 가지 방식을 지원합니다. <br>1. 맵 에디팅을 통해 직접 맵을 생성후 플레이 <br>2. 스토리를 따라 스테이지형 맵을 플레이 |
| **담당 개발 내용** | 게임 장애물 개발, 친구목록 등 UI, 게임 진행도 UI, 음성퀴즈 (AI 협업, WebSocket) |

<br>

# <mark>구현 상세 설명</mark>
구현 기능의 소스 코드는 각 소제목 밑의 링크를 통해 확인하실 수 있습니다.<br>
각 기능의 더 자세한 설명은 [여기](https://www.notion.so/kimskye/1ceb7f13b7a68181a1e4ddf2c48ec842)서도 확인하실 수 있습니다.

---
## <mark>1. UI / UX 개발</mark>
게임의 전반적인 UI 및 UX 개발을 담당했습니다.

### <mark>친구목록 및 방 목록 UI</mark>
> [방 목록 UI 오브젝트 풀링 소스코드](https://github.com/kimskyeee/GoUpFrog/blob/main/Source/JumpGame/UI/ClientRoomUI.cpp#L225C1-L290C2)
...
### <mark>화면 전환 카메라 컴포넌트</mark>
> [카메라 컴포넌트 소스코드](https://github.com/kimskyeee/GoUpFrog/blob/main/Source/JumpGame/UI/UICam/LobbyCameraComp.cpp#L51C1-L66C2) <br>
> [카메라 컴포넌트 델리게이트 예 소스코드](https://github.com/kimskyeee/GoUpFrog/blob/main/Source/JumpGame/UI/ClientRoomUI.cpp#L79C2-L92C2)
...
### <mark>게임 진행도 UI</mark>
> [게임 진행도 UI 소스코드드](https://github.com/kimskyeee/GoUpFrog/blob/main/Source/JumpGame/UI/GameProgressBarUI.cpp#L61C1-L106C1)

멀티플레이시 게임 시작 지점(Prop)과 끝 지점(Prop)의 z좌표 위치를 받아와 **1등 플레이어를 기준**으로 전체 진행률을 계산하는 UI를 구현하였습니다.
...
## <mark> 2. 게임 장애물 개발</mark>
> [ABaseProp 소스코드](https://github.com/kimskyeee/GoUpFrog/blob/main/Source/JumpGame/Props/BaseProp.cpp) <br>
> [AObstacleProp 소스코드](https://github.com/kimskyeee/GoUpFrog/blob/main/Source/JumpGame/Props/ObstacleProp/ObstacleProp.cpp)
...
### <mark>`LaunchCharacter` 동기화</mark>
> [장애물 충돌 발생 LaunchCharacter 소스코드](https://github.com/kimskyeee/GoUpFrog/blob/main/Source/JumpGame/Props/ObstacleProp/ObstacleProp.cpp#L139C1-L151C3) <br>
> [클라이언트 예측 LaunchCharacter 소스코드](https://github.com/kimskyeee/GoUpFrog/blob/main/Source/JumpGame/Characters/Frog.cpp#L925C1-L943C2)
...
### <mark>대포 장애물: 오브젝트 풀링</mark>
> [대포 장애물 풀 소스코드](https://github.com/kimskyeee/GoUpFrog/blob/main/Source/JumpGame/Props/SpawnProp/ObjectPoolComponent.cpp)
...
## <mark>3. AI 협업 WebSocket기반 음성퀴즈
> [WebSocket기반 음성퀴즈 소스코드](https://github.com/kimskyeee/GoUpFrog/blob/main/Source/JumpGame/Props/ObstacleProp/SoundQuizProp/SoundQuizProp.cpp)
> 
